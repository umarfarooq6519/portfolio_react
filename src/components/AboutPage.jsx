function AboutPage() {
  return (
    <section className="AboutPage border min-h-screen px-10 py-12 md:px-24 md:py-14 flex flex-col gap-10 w-full justify-center items-center">
      ...
      <div className="about-main flex max-xl:flex-col gap-12 md:gap-20 items-center justify-center w-full">
        <span className="max-w-xl md:text-lg text-justify">
          <h3 className="heading text-2xl pb-2">Why Me?</h3>
          Hey Peeps! I'm Umar, located in Lahore, Pakistan. I'm a Web Developer
          with over 2+ years of hands-on experience in crafting dynamic and
          user-focused websites, bringing ideas to life in the browser.
          <br /> <br /> What sets me apart from others is the dedicated
          concentration on the websites purpose. I prioritize understanding the
          intended use of the website and how the user will interact with the
          interface.I maintain ongoing communication with my clients to ensure a
          ...
          <ol className="relative max-w-lg border-s border-neutral-content">
            <span className="flex flex-col gap-2">
              <li className="ms-4">
                ...
                <p>
                  Learnt the JavaScript framework “Vue Js”. Built a login/signup
                  page using Vue Js and implemented local storage for user’s
                  data.
                </p>
              </li>
            </span>
