function AboutPage() {
  const about_paragraph = (
    <span className="max-w-xl text-center">
      <span className="font-medium">Hey Peeps!</span> I'm Umar, a Web Developer
      located in <span className="font-medium">Pakistan</span> with over
  ...
  return (
    <section className="AboutPage border min-h-screen px-10 py-12 md:px-24 md:py-14 flex flex-col gap-10 w-full justify-center items-center">
      ...
      <div className="about-main flex flex-col gap-16 items-center justify-center w-full">
        {about_paragraph}
        <div className="about-timeline lg:flex gap-20 justify-between text-justify">
          <div className="education-timeline max-w-sm">
            <h3 className="heading text-2xl text-center pb-2">Education</h3>
            <Education />
          </div>

          <div className="work-timeline max-w-sm">
            <h3 className="heading text-2xl text-center pb-2">
              Work Experience
            </h3>
            <WorkExp />
          </div>
